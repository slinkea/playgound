...
class AscanDatasetBase : public Dataset
{
public:
  AscanDatasetBase(hid_t dsetId_, const std::string& location_)
  ...
  AscanDatasetBase(const AscanDatasetBase&) = default;
  virtual ~AscanDatasetBase() = default;

  AscanDatasetBase() = delete;
  AscanDatasetBase& operator=(const AscanDatasetBase&) = delete;
